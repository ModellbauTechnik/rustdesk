...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem isrv.ch Desk-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann RustDesk in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren isrv.ch RustDesk auf dem System."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie isrv.ch RustDesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ...
        ("Language", "Sprache"),
        ("Keep RustDesk background service", "isrv.ch Desk im Hintergrund ausführen"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie isrv.ch RustDesk die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass isrv.ch RustDesk als kontrollierte Seite nicht richtig läuft."),
